 ...
 */
package org.openmrs.module.hl7export.web.controller;
...
/**
 * This class configured as controller using annotation and mapped with the URL of 'module/hl7export/basicmoduleLink.form'.
 */
@Controller
@RequestMapping(value = "module/hl7export/basicmoduleLink.form")
public class Hl7ExportFormController{
